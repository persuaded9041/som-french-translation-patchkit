...
| `0x074C86` | `$C7:4C86` | Base DTE threshold for component-02 router (`$E1` standalone) |
...
When 06/08 are present, their later full dialogue router owns `$C0:16F5` instead;
component 02's private helper remains unused and harmless.
