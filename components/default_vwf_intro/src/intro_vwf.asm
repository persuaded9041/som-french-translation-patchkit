...
; ../../shared/vwf/text_buffer.py; see ../../shared/vwf/text_buffer.asm.
org $C017CE
...
; ../../shared/vwf/row_renderer.py. It performs the stock font-row load, calls
...
; ../../shared/vwf/compositor.py; see ../../shared/vwf/compositor.asm. It owns
...
; ../../shared/vwf/framing.py from the same logic used by `vwf_dialogues`. It
...
; Their executable source is ../../shared/vwf/text_buffer.py and the readable
; 65816 reference is ../../shared/vwf/text_buffer.asm.
;
