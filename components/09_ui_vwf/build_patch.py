...
The component is independent of component 06; only byte-identical shared VWF
...
STOCK_BUFFER = 0xA1A4
PIXEL_CURSOR = 0x9382
SLOT_INDEX = 0x93C3       # 16-bit, component-09 render-only scratch
GLYPH_INDEX = 0x93C5      # 16-bit
RENDER_COUNT = 0x93C7     # legacy scratch; retained for map stability
...
def make_ui_renderer() -> bytes:
    ...
    not require component 06 or translated resource names.
    """
...
def build(base: bytes) -> bytes:
    ...
    # Shared infrastructure: standalone-safe and byte-identical with 05/06.
