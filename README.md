...
`name_entry_extended`, `french_menus`, `french_opening`, and `french_intro` have been migrated there.
...
The current versioning checkpoint is **Round 77 — intro VWF/French payload split**. The dialogue payload itself remains the locked **Round 72 — automatic 216 px completion** state.
