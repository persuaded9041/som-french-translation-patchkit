...
**simulator-filtered mass pass**. The current corpus contains **526 simulator-clean events /
1138 visible semantic source IDs / 1196 JSON entries**: **525 complete + 1 PARTIEL**.
...
The remaining exclusions are 161 alignment-incomplete events and 17 formatter rejects.
...
otherwise be overwritten. The 526-event corpus as a whole still requires the planned
