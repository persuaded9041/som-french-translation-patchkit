...
**simulator-filtered mass pass**. The current corpus contains **521 simulator-clean events /
1122 visible semantic source IDs / 1179 JSON entries**: **520 complete + 1 PARTIEL**.
