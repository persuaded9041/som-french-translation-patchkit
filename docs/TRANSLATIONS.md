...
- `translations/dialogues_french.json`: generated by the conservative
  ...
  526 simulator-clean events / 1138 visible semantic source IDs (1196 JSON entries
  ...
  The full 526-event corpus still requires playthrough.
...
`--only dialogue-format-mass`: **526 simulator-clean events / 1138 visible semantic
source tokens** (1196 JSON entries including generated layout/supplement entries). The
