...
- `translations/dialogues_french.json`: generated by the conservative
  ...
  510 simulator-clean events / 1078 visible semantic source IDs (1129 JSON entries
  ...
  The full 510-event corpus still requires playthrough.
...
`--only dialogue-format-mass`: **510 simulator-clean events / 1078 visible semantic
source tokens** (1129 JSON entries including generated layout/supplement entries). The
