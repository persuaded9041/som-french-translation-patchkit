...
commands. `french_name_entry_extended`, `french_menus`, `french_opening`, `french_intro`, `french_dialogues`, and `french_shop_text` are the current translated component consumers of the
