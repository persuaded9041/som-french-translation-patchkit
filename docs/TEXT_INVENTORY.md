...
commands. `french_name_entry_extended`, `french_menus`, `french_opening`, `french_intro`, and `french_dialogues` are the current translated component consumers of the
