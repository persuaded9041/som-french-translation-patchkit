...
| 9-char names | `0x244000+` | `$E4:4000+` | four character rows + French help text |
...
The Name Entry private layout begins after the intro VWF DTE allocation and has
no byte overlap with it. GAME SELECT's relocated label block also ends before
the intro VWF width table.
