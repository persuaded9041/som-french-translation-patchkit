...
; ==============================================
; Readable reference for shared/dialogue_dte.py (executable canonical source).
;
; Components 06/08 replace stock CMP #$D3 / BCS upper_dte at $C0:16F5 with
...
org $C74570
dialogue_dte_route:
    ; See dialogue_dte.py for generated machine code. When component 06 is
    ; active, the helper first trusts the shared parser mode selected at
    ; $C0:16B8: mode 2 -> dialogue/$E8, mode 1 -> intro/$E6. Mode 0 and
    ; component-08 standalone builds fall back to caller/event checks. It JMLs
