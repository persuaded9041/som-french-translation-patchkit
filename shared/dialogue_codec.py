...
def encode_translated_dialogue_text(text: str) -> bytes:
    """Encode translated text plus generated page-break markers.

    A form-feed (``\f``) is an internal layout marker generated by the Android
    formatter. It compiles to the stock ``WAIT $00`` + ``TEXT_CLEAR`` command
    pair, which gives the player an explicit page advance before rendering the
    following text at the top of the same dialogue box.
    """
