"""Shared stock-outline preparation for VWF `vwf_intro`, `vwf_dialogues`, and `vwf_ui`.
...
This one-byte patch was already runtime-validated through `vwf_intro`. Keeping
it in one shared installer also makes `vwf_dialogues` standalone match the outline
