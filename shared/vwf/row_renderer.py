"""Shared stock-font VWF row renderer for `vwf_intro`, `vwf_dialogues`, and `vwf_ui`.
...
from .framing import SHARED_FRAMING_CALL
from .compositor import COMPOSITOR_CALL
